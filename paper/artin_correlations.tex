...
$4d$ otherwise; in both cases the discriminant divides $4d$, so the excluded set
...
and we claim no priority for it; (ii)~a measurement, over the primes below $10^9$, of the
