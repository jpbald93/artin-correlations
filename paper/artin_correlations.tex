...
\begin{abstract}
	...
	joint-residue baseline, which itself carries $0.4195$ nats; a permutation null shows a real but very small predecessor signal at modulus $120$
	(of order $10^{-6}$ nats) and none detectable at modulus $840$ --- far too small to guide a search.
...
\begin{enumerate}
	...
	beyond the elementary joint-residue baseline --- real at modulus $120$, not detectable at
	modulus $840$, and far too small to guide a search; both exclusion laws are computationally
...
of those correlations, which is real but far too small to be usable (\S\ref{sec:content}). The exclusion laws are immediate
